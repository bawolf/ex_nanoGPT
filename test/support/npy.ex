defmodule ExNanoGPT.Test.Npy do
  @moduledoc """
  Minimal NumPy .npy file reader for loading golden test data.

  Supports float32 and int64 arrays (the types our extract.py generates).
